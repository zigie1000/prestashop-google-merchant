...
class googlemerchant extends Module
{
    ...
    public function generateFeed()
    {
        ...
        foreach ($products as $product) {
            ...
            // Add EAN (GTIN) field
            $item->addChild('gtin', isset($product['ean13']) ? htmlspecialchars($product['ean13']) : '');
        }
    ...
    {
        $sql = 'SELECT p.id_product, pl.name, pl.description, p.price, i.id_image, pl.link_rewrite, p.quantity, p.ean13
