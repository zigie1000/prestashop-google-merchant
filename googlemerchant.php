...
class googlemerchant extends Module
{
    ...
    public function generateFeed()
    {
        ...
        foreach ($products as $product) {
            ...
            // Ensuring the correct currency is used or fallback to ZAR if not set
            $iso_code = isset($this->context->currency->iso_code) ? $this->context->currency->iso_code : 'ZAR';
            $item->addChild('g:price', Tools::displayPrice($product['price'], $iso_code));
