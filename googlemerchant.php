...
class googlemerchant extends Module
{
    ...
    public function generateFeed()
    {
        ...
        $categoryMapping = $this->loadCategoryMapping();
        ...
        foreach ($products as $product) {
            ...
            $googleCategory = isset($categoryMapping[$productCategory]) ? $categoryMapping[$productCategory] : '';
            $item->addChild('g:product_type', $productCategory);
            $item->addChild('g:google_product_category', $googleCategory);
